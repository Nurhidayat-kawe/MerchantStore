...
public class LapTransaksiPenjualanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lap_transaksi_penjualan);
        ...
        context = LapTransaksiPenjualanActivity.this;
        btn_pick_1 = findViewById(R.id.btn_rekap_penjualan_tgl_awal);
        btn_pick_2 = findViewById(R.id.btn_rekap_penjualan_tgl_ahir);
        tv_date_awal = findViewById(R.id.tv_rekap_penjualan_tgl_awal);
        tv_date_ahir = findViewById(R.id.tv_rekap_penjualan_tgl_ahir);
        btn_cari = findViewById(R.id.btn_rekap_penjualan_cari);
        mRecycler = findViewById(R.id.rv_rekap_penjualan_all);
...
//                            tv_date_ahir.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
    ...
    private void getPendapatan(String tgl_awal, String tgl_ahir) {
        transaksis.clear();
        Call<ResponseTransaksi> getdata = mApiService.getRekapTransaksi(tgl_awal, tgl_ahir);
