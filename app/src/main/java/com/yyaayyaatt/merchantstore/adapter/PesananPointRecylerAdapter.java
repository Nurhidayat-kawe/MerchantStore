...
import com.yyaayyaatt.merchantstore.DetailPesananPointActivity;
...
public class PesananPointRecylerAdapter extends RecyclerView.Adapter<PesananPointRecylerAdapter.MyHolder> {
    ...
    public PesananPointRecylerAdapter(Context ctx, List<Transaksi> mList) {
        this.mList = mList;
        this.ctx = ctx;
    ...
    public void onBindViewHolder(MyHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.btn_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ctx, DetailPesananPointActivity.class);
