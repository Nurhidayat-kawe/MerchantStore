...
public class UpdateProdukActivity extends AppCompatActivity {
    ...
    EditText txt_jml_beli, txt_harga_diskon, txt_jml_point;
    Spinner sp_kat, sp_satuan;
    AppCompatButton btn_simpan;
    String id_produk, nama, harga_jual, harga_beli, desc, kat, sat, user, harga_diskon, jml_beli;
    int jml_point;
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nama.isEmpty()) {
                    ...
                    simpan(id_produk, nama, harga_jual, harga_beli, desc, kat, sat, user, jml_beli, harga_diskon, jml_point);
                }
            }
        });
    }
    ...
    private void simpan(String id_produk, String nama, String harga_jual, String harga_beli, String desc, String kat, String sat, String user, String jml_beli, String harga_diskon, int jml_point) {
        Call<ResponseProduk> getdata = mApiService.updateProduk(id_produk, nama, kat, harga_beli, sat, desc, user, harga_jual, jml_beli, harga_diskon, jml_point);
