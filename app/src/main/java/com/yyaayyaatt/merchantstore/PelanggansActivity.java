...
import com.yyaayyaatt.merchantstore.adapter.PelanggansRecylerAdapter;
...
public class PelanggansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pelanggans);
        mRecycler = findViewById(R.id.rv_pelanggans);
        mContext = PelanggansActivity.this;
    ...
    private void getPelanggan() {
        pelanggans.clear();
        Call<ResponsePelanggan> getdata = mApiService.getPelanggans();
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getmKode().equals("1")) {
                        ...
                        if (!pelanggans.isEmpty()) {
                            mAdapter = new PelanggansRecylerAdapter(mContext, pelanggans);
